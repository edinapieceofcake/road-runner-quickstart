...
public class SampleMecanumDriveREV extends SampleMecanumDriveBase {
    ...
    public SampleMecanumDriveREV(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "fl"); //br
        leftFront.setDirection(DcMotorSimple.Direction.REVERSE);
        leftRear = hardwareMap.get(DcMotorEx.class, "bl"); //fr
        leftRear.setDirection(DcMotorSimple.Direction.REVERSE);
        rightRear = hardwareMap.get(DcMotorEx.class, "br"); //fl
        rightFront = hardwareMap.get(DcMotorEx.class, "fr"); //bl
