 ...
 */
public class SampleMecanumDriveREVOptimizedWithoutOdo extends SampleMecanumDriveBase {
    private ExpansionHubEx hub2, hub9;
    private ExpansionHubMotor leftFront, leftRear, rightRear, rightFront;
    private List<ExpansionHubMotor> motors;
    private BNO055IMU imu;

    public SampleMecanumDriveREVOptimizedWithoutOdo(HardwareMap hardwareMap) {
        super();
